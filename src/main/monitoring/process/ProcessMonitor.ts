...
/**
 * Имена системно-критичных процессов Windows, которые не должны завершаться
 * через SystemDeck. Классификация — источник правды в Main; Renderer лишь
 * читает флаг `protected` из контракта (ADR 0011).
 */
